...
public class CustomExceptionHandler {
    ...
    @ExceptionHandler(com.mycompany.propertymanagement.exception.BusinessException.class)
    public ResponseEntity<List<ErrorModel>> handleBusinessException(com.mycompany.propertymanagement.exception.BusinessException bex){
